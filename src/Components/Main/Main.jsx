...
const Data = [
  ...
  },
  {
    ...
    fees: "$790",
    description:
      "Angkot Wat represents the entire range of Khmer are from the 9th to the 15th century. This temple is considered the heart and soul of Cambodia. This place is known for its luxurious stays and adventurous activities.",
  },
  {
    id: 8,
    imgSrc: img8,
    ...
    fees: "$900",
    description:
      "An immense mausoleum of white marble, built-in Agra by Mughal emperor Shah in memory of his wife Mumtaz, the monument is breathtakingly beautiful. This place is known for its luxurious stays and adventurous activities. ",
  },
  {
    id: 9,
    imgSrc: img9,
    ...
    fees: "$500",
    description:
      "Bali is an Indonesian island and one of the best holiday destinations in the Indonesian archipelago. Bali is known for its volcanic mountains, history, art & cultire, food, temples and beautiful sandy beaches.  ",
  },
];
...
const Main = () => {
  ...
  return (
    <>
      <section className="main container section" id="most-visited">
            ...
            return (
              <div key={id} data-aos="fade-up" className="singleDestination">
                ...
                <div className="cardInfo">
                  ...
                  {/*<button className="btn flex" onClick={() => setShowingDetails(flight)}>
