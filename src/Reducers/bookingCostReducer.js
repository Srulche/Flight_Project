...
//       let total = state.flightPrice;
//       for (let i = 0; i < adult_count; i++) {

//         // over the weight-limit luggage (30$ per extra 4.5kg)
//         if (state.luggageWeight > 20) {
//           total += +(((state.luggageWeight - 20) / 4) * 30);
//         }
//         if (i > 0)
//           // i = number of adults
...
//     case "LUGGAGE_WEIGHT":
//       return { ...state, luggageWeight: +parameter.value };
//     case "MEAL_TYPE":
